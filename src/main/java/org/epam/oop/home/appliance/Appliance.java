...
public class Appliance extends Device{
    ...
    public Appliance(TypeOfDevice typeOfDevice,  String name, int powerOfAppliance, int weightOfAppliance, boolean stateOfAppliance, boolean kitchenAppliance) {
    ...
    public String toString() {
        return ANSI_GREEN + "Device type:" + typeOfDevice + "\t" + ANSI_RED + "Name of device:" + name + "\t" + ANSI_PURPLE + "Power:" + powerOfAppliance + "\t" +
